...
$result = mysqli_query($conn, "SELECT * from hanghoa where soluonghang >0 ORDER BY mshh ASC LIMIT $perRow,$rowsPerPage");
$totalRows=mysqli_num_rows(mysqli_query($conn,"SELECT * from hanghoa where soluonghang >0"));
$totalPages = ceil($totalRows/$rowsPerPage);
$nextPage="";
$previous = "";
for($i=1;$i<=$totalPages;$i++){
    if($page == $i && $page >1 && $page <$totalPages && $totalPages > 1 ){
        $previous = '<a class="home-filter_page-btn" href="index.php?page_layout=conhang&page='.($page-1).'"> <i class="home-filter_page-icon fas fa-angle-left"></i></a>';
        $nextPage = '<a class="home-filter_page-btn" href="index.php?page_layout=conhang&page='.($page+1).'"> <i class="home-filter_page-icon fas fa-angle-right"></i></a>';
    } else if($page==1 && $totalPages > 1){
        $previous='<a class="home-filter_page-btn home-filter_page-btn--disabled" href="index.php?page_layout=conhang&page='.$page.'" style="pointer-events: none;"><i class="home-filter_page-icon fas fa-angle-left"></i></a>';
        $nextPage='<a class="home-filter_page-btn" href="index.php?page_layout=conhang&page='.($page+1).'"><i class="home-filter_page-icon fas fa-angle-right"></i></a>';
    } else if($page == $totalPages && $totalPages > 1){
        $previous = '<a class="home-filter_page-btn" href="index.php?page_layout=conhang&page='.($page-1).'"> <i class="home-filter_page-icon fas fa-angle-left"></i></a>';
        $nextPage='<a class="home-filter_page-btn home-filter_page-btn--disabled" href="index.php?page_layout=conhang&page='.$page.'" style="pointer-events: none;"><i class="home-filter_page-icon fas fa-angle-right"></i></a>';
    } else if($page==1 && $totalPages == 1){
        $previous = '<a class="home-filter_page-btn home-filter_page-btn--disabled" href="index.php?page_layout=conhang&page='.$page.'" style="pointer-events: none;"> <i class="home-filter_page-icon fas fa-angle-left"></i></a>';
        $nextPage='<a class="home-filter_page-btn home-filter_page-btn--disabled" href="index.php?page_layout=conhang&page='.$page.'" style="pointer-events: none;"><i class="home-filter_page-icon fas fa-angle-right"></i></a>';
    }
            ...
            <div class="grid_row app_content">
                ...
                <div class="grid_column-10">
                    <div class="home-filter">
                        ...
                        <a href="index.php" class="home-filter_btn btn ">Mặc Định</a>
                        ...
                        <a href="index.php?page_layout=conhang" class="home-filter_btn btn btn--primary">Còn Hàng</a>
                    ...
                    <div class="home-product">
                       <script>
                            ...
                            function getSearch(a){
                              ...
                              null==xmlhttp?alert("Trình duyệt không hỗ trợ HTTP Request"):(xmlhttp.onreadystatechange=stateChanged,xmlhttp.open("GET","./getData/getDataCH.php?key="+a,!0),xmlhttp.send(null))
                            }
